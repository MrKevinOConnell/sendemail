...
def sendEmail(x,y,z):
    dotenv = DotEnv('/Users/kevinoconnell/Desktop/sendemail/.env')
    ...
    file = '/Users/kevinoconnell/Desktop/sendemail/KevinOConnellResume.pdf'
    ...
    send.ehlo()
    send.starttls()
    send.login(email, dotenv.get('PASSWORD'))
...
if len(sys.argv)== 2:
    if(sys.argv[1] == 'r'):
        ...
        with open("/Users/kevinoconnell/Desktop/sendemail/emails.txt") as emails:
            for line in emails:
                founder = line.split()
                for l in founder:
        ...
        open("/Users/kevinoconnell/Desktop/sendemail/emails.txt", "w").close()
